========================================================================
    APLICACIÓN DE CONSOLA: Segundo Proyecto - Arboles Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Segundo Proyecto - Arboles.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Segundo Proyecto - Arboles.


Segundo Proyecto - Arboles.vcxproj
...
Segundo Proyecto - Arboles.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Segundo Proyecto - Arboles.pch y un archivo de tipos precompilados llamado StdAfx.obj.
